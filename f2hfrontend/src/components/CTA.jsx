            ...
            <section className="py-20 relative overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto px-4 relative z-10 text-center reveal">
                    ...
                    <div ref={ref} className="flex flex-col sm:flex-row gap-4 justify-center">
                        <button onClick={()=>handleRegister(true)} className="flex justify-center gap-2 px-8 py-4 bg-white text-green-700 rounded-full font-bold hover:bg-orange-500 hover:text-white transition shadow-black shadow-2xl hover:shadow-none  hover:-translate-y-5 duration-500">
                            <Sprout />
                            Join as a Farmer
                        </button>
                        <button onClick={()=>handleRegister(false)} className="flex justify-center gap-2 px-8 py-4 bg-transparent border-2 border-white text-white rounded-full shadow-2xl shadow-black/80 font-bold hover:bg-green-500 transition duration-500 hover:shadow-none hover:-translate-y-5">
                            <ShoppingBasket />
                            Join as a Buyer
                        </button>
