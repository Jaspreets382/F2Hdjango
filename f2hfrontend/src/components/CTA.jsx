            ...
            <section className="py-20 relative overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto px-4 relative z-10 text-center reveal">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="#" className="flex gap-2 px-8 py-4 bg-white text-green-700 rounded-full font-bold hover:bg-orange-500 hover:text-white transition shadow-black shadow-2xl hover:shadow-none  hover:-translate-y-5 duration-500">
                            <Sprout />
                            Join as a Farmer
                        </a>
