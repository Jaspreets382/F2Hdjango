    ...
    return (
        ...
        <>
            <section className='relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden'>
                ...
                <div class="absolute -bottom-8 left-20 w-72 h-72 z-0 bg-purple-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
                ...
                <div className=" max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        {/* floating card */}
                        <div class="relative lg:h-150 flex items-center justify-center reveal animation-delay-200">
                            <div class="absolute top-10 left-0 z-20 bg-white p-4 rounded-2xl shadow-xl animate-float">
                                <div class="flex items-center gap-3">
                                    <div class="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center text-primary-600 text-xl">
                                        <Carrot fill='#17b401' stroke='white' strokeWidth={0.5} size={28}/>
                                    </div>
                                    <div>
                                        <p class="text-xs text-gray-500">Fresh Order</p>
                                        <p class="font-bold text-gray-800">Organic Carrots</p>
                                    </div>
                                </div>
                            </div>

                            <div class="absolute bottom-20 right-0 z-20 bg-white p-4 rounded-2xl shadow-xl animate-float animation-delay-2000">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-bold text-green-600">On the way</p>
                                    </div>
                                </div>
                            </div>

                            {/* hero image */}
                            <div class="relative w-full h-100 lg:h-125 rounded-[3rem] overflow-hidden shadow-2xl  shadow-sky-500/50 border-4 border-white transform -rotate-3 hover:rotate-3 transition duration-600 ">
                                <img src="https://images.unsplash.com/photo-1488459716781-31db52582fe9?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80" alt="Fresh vegetables farming" class="w-full h-full object-cover" />
