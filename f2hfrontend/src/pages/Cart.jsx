...
function Cart() {
    ...
    return (
        ...
        <div className="w-full max-w-full overflow-x-hidden min-h-screen">
            ...
            <div className="max-w-[100vw] overflow-x-hidden px-2 md:px-20 bg-amber-200/30 ">
                <div>
                            ...
                            <div className="relative flex items-center p-5 bg-amber-400/70 backdrop-blur-xl rounded-[2.5rem] border border-white/50 shadow-xl shadow-green-900/5 mb-6 group transition-all hover:-translate-y-1 ">
                                ...
                                <div className=" w-full flex justify-between px-4">
                                    ...
                                    <div className="flex gap-10 text-end flex-col">
                                        ...
                                        <button className="bg-red-600 text-white inline-block w-max p-2  rounded-4xl font-bold border-2 border-slate-100 shadow-inner" onClick={() => removeFromCart(item.id)}>Remove</button>
                                    </div>
                                </div>
                            </div>
                        ))}
        ...
        `}
                    ...
                    <div className="md:hidden lg:col-span-1 w-full mx-auto max-h-fit border-2 border-white shadow-2xl bg-slate-900 rounded-[3rem] p-8 text-white overflow-hidden group">
                        {/* Artistic Background Accent */}
                        <Leaf className="absolute bottom-30 right-4  text-white/5 w-40 h-40 rotate-12 transition-transform group-hover:rotate-45 duration-700 " />
