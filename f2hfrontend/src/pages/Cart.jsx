...
function Cart() {
    ...
    return (
        <>
            ...
            <div className="px-20 bg-amber-200/30 ">
                <div>
                ...
                {cart.length != 0 ? (<div className="grid grid-cols-2 min-h-screen ">
                    <div >
                        {cart.map(item => (
                            <div className="relative flex items-center p-5 bg-amber-600/70 backdrop-blur-xl rounded-[2.5rem] border border-white/50 shadow-xl shadow-green-900/5 mb-6 group transition-all hover:-translate-y-1 ">
                    ...
                    <div className=" sticky top-32 lg:col-span-1 w-md mx-auto max-h-fit border-2 border-white shadow-2xl bg-slate-900 rounded-[3rem] p-8 text-white overflow-hidden group">
