            ...
            <div className="absolute top-200 right-30 w-62 h-62 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
                ...
                <main className="max-w-4xl w-full fade-in mx-auto py-20 ">
                    <div className="text-center mb-10">
                        <h1 className="text-4xl md:text-5xl font-bold bg-linear-to-r from-green-900 to-green-300 from-30% bg-clip-text text-transparent  mb-2">Register to join our fresh produce marketplace</h1>

                    </div>

                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="bg-white glass-card p-6 md:p-8 rounded-2xl hover:shadow-2xl hover:scale-103 ease-in duration-150">
